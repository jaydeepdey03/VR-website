                ...
                <div className='bg-golden flex flex-col h-full w-full p-10 m-2 rounded-xl shadow-md'>
                    ...
                    <div className='space-y-6'>
                        ...
                        <div className='flex flex-col justify-center items-center space-y-6'>
                            ...
                            <button style={{background: "linear-gradient(90deg, rgba(255,81,81,1) 0%, rgba(255,165,0,1) 100%)"}} className="flex justify-center items-center space-x-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">
